...
cite_text = '"Folks are usually about as happy as they make their minds up to be."'
cite_author = "Abraham Lincoln"
cite_link = "https://en.wikipedia.org/wiki/Abraham_Lincoln"
description_text = '''On the map below you see the happiness score mapped onto each country. The results are gathered from the Gallup World Poll. The score is computed based on the answers from people of these countries in 2021. Below the map you will also find a list of the Top 20 countries based on the Happiness Score.'''
