...
description_text = '''On the map below you see the generosity score mapped onto each country. The score ranges from -1 to 1. The results are gathered from the Gallup World Poll. Below the map you will also find a list of the Top 20 countries based on the generosity score.'''
