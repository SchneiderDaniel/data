...
description_text = '''On the map below you see the a score that measures the perception of people on corruption in their country. The score ranges from 0 to 1. The results are gathered from the Gallup World Poll. Below the map you will also find a list of the Top 20 countries based on the score.'''
